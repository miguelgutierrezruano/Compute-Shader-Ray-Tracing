...
public class cpuSideCode : MonoBehaviour {
	...
	static public double[] areaRectArray;				// this array will contain the numbers that will be passed into the buffer
	...
	static public ComputeShader _shader;				// we will need to link the code to this class, and then we'ĺl use it to actually run kernels from the code
